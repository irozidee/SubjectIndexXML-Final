...
Public Class Keyword_Subject_Index
    ...
    Private Sub DataGridView_LoadData()
        ...
        mySqlConn.Open()
        query = "select id, old_value, new_value from keyword_subject_index"
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        For Each selectedRow As DataGridViewRow In dgvLegislation.SelectedRows
            ...
            delQuery = "delete from keyword_subject_index where id=" & selectedId
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        For Each selectedRow As DataGridViewRow In dgvLegislation.SelectedRows
            ...
            updateQuery = "update from keyword_subject_index set old_value='" & oldS & "' and new_value='" & newS & "' where id=" & selectedId
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Dim insertSQL As String = "insert into keyword_subject_index (old_value, new_value) values('" & txtOldKeyword.Text & "','" & txtNewValue.Text & "')"
